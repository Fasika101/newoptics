...
if (empty($_POST['product_name'])) {
    ...
    if ($valid == 1) {
        ...
        $success_message .= 'We will send a sales person to show you the products you chose. Thank you.';
...
if (empty($_POST['cust_phone'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='webp' ) {
            $valid = 0;
            $error_message .= 'You must have to upload jpg, jpeg, webp, gif or png file.';
        }
    } else {
    	$valid = 0;
        $error_message .= 'You must have to upload a photo of damaged product.';
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Pho is added successfully.';
...
?>    <section class="bg-white dark:bg-gray-900">
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-5">
            <h1 class="max-w-2xl mb-4 text-1xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-1xl dark:text-white">See Frame First</h1>
            ...
            <div class="col-span-2 sm:col-span-1">
              <label for="card-number-input" class="mb-2 block text-2xl font-medium text-gray-900 dark:text-white">Address </label>
              <input type="text" id="card-number-input" name="cust_address" value="" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pe-10 text-2xl text-gray-900 focus:border-primary-500 focus:ring-primary-500  dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="Address" required />
            </div>
            <div class="col-span-2 sm:col-span-1">
              ...
              <span style="color: #f1b70a !important;">You can choose up to 5 instock products seprated by a comma.
              .</span></p>            </div>
            <div class="col-span-2 sm:col-span-1">
              <label for="card-number-input" class="mb-2 block text-2xl font-medium text-gray-900 dark:text-white"> Date</label>
          ...
          <button name="see_frame_form" type="submit" class="flex w-full items-center justify-center rounded-lg bg-yellow-300 px-5 py-2.5 text-2xl font-medium text-white hover:bg-yellow-800 focus:outline-none focus:ring-4  focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Submit</button>
        </form>

        </div>
        <div class="mr-auto place-self-center lg:col-span-5">
            <img src="assets/img/free.png" alt="mockup">
        </div>                
    </div>
</section>
