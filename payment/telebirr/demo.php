		...
		<div class="label-panel">
			...
			<form action="submit.php" method="post">
				...
				<div class="label-rows">
					...
					<div><input id="appid" name="appid" value="247e88b4897441dd996f89fbe7aa02db"></div>
				...
				<div class="label-rows">
					...
					<div><input id="subject" name="subject" value="<?php echo $produt_name;?>"></div>
					<div class="label-title">Goods Amount:</div>
					<div><input id="totalAmount" name="totalAmount" value="<?php echo $table_total_price;?>"></div>
				</div>
				<div class="label-rows">
					<div class="label-title">Short Code:</div>
					<div><input id="shortCode" name="shortCode" value="220333"></div>
					<div class="label-title">Receive Name:</div>
					<div><input id="receiveName" name="receiveName" value="New Online Optics"></div>
