...
if (isset($_POST['add_new_promo'])) {
    ...
    if (empty($_POST['promo_code'])) {
        ...
        $statement->execute(array($_POST['promo_code']));
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Company Promo Code Mangement</h1>
	</div>
	<div class="content-header-right">
		<a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_promo">Add New Promo</a>
	</div>
</section>
				...
				<div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
$i = 0;
$statement = $pdo->prepare("SELECT * FROM promo WHERE company=1");
$statement->execute();
...
foreach ($result as $row) {
    ...
    ?>
								<tr class="<?php if ($row['status'] == 1) {echo 'bg-g';} else {echo 'bg-r';}?>">
									...
									<td>
										<a href="promo_comp_status.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-xs">Change Status</a>
									</td>
									
                                    <td>
	                                      <a href="promo_comp_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
...
<!-- //add custom promo -->
<div class="modal fade" id="add_promo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Add new Promo Code</h4>
            </div>
            <div class="modal-body">
                ...
                <form action="" method="post" >                                           
                                        ...
                                        <div class="form-group">
                                             <label for="">Promo Name</label><br>
                                              <input type="text" name="name" style="font-size:14px;" value="" ></input><br>
                                              <input type="hidden" name="company" style="font-size:14px;" value="1" ></input>
                                        </div>
                                       
                                        <div class="form-group">
                                              <label for="">Promo Code</label><br>
                                              <input type="text" name="promo_code" style="font-size:14px;" value="" >
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="modal-footer">
                                             <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                                            <input type="submit" class="btn btn-success" value="<?php echo 'Submit'; ?>" name="add_new_promo">
                                        </div>
                                    </form>     
            </div>
