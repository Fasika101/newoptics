        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_payment where cust_type='partner' ");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
                            ...
                            <br>------------------<br>
                            Pick up person info<br>
                            <b>Name:</b><?php echo $row['partner_pickup_name']; ?><br>
                            <b>Phone:</b><?php echo $row['partner_pickup_number'];?><br>
                            <b>Pick up place:</b><?php echo $row['partner_drop_address'];?><br>
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo '<br>(<b>Lens Type:</b> ' . $row1['lens_type'];
                                ...
                                echo ', <b>Total Price</b> Price:</b> '.$row1['unit_price'].'ETB)';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
                        ...
                        <td>
                            ...
                            <?php
                                if($row['payment_status']=='Pending'){
                                    ?>
                                    <a href="partner-order-change-status.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Make Completed</a>
                                    <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            if($row['payment_status']=='Completed') {
                                if($row['shipping_status']=='Pending'){
                                    ?>
                                    <a href="shipping-change-status_partner.php?id=<?php echo $row['id']; ?>&task=Completed" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Make Completed</a>
                                    <?php
                                }
                            }
                            ?>
