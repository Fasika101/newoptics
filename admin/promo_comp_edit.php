...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="promo_custom.php" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="customer_name" value="<?php echo $name; ?>" >
                                    <input type="hidden" class="form-control" name="cust_id" value="<?php echo $id; ?>" readonly>

                                </div>
                                <div class="form-group">
                                    <label for="">Promo Code </label>
                                    <input type="text" class="form-control" name="customer_promo" value="<?php echo $name;?>" >
                                </div>
