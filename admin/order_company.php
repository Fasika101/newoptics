        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_payment where cust_type='company' ");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
	                    ...
	                    <td>
                            ...
                            <b>Name:</b><?php echo $row['company_pickup_name']; ?><br>
                            <b>Phone:</b><?php echo $row['company_pickup_number'];?><br>
                            <b>Pick up place:</b><?php echo $row['company_drop_address'];?><br>
