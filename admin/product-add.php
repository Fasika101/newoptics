...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "You must have to select a Men or Women or Kids<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "You must have to select a Shape/Frame Type<br>";
    }
...
// 		}
		...
		if(isset($_POST['color'])) {
			foreach($_POST['color'] as $value) {
				...
				$statement->execute(array($value,$ai_id,'0'));
			}
		}
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Women | Men | Kids <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Shape/Frame Type <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Price <span>*</span><br><span style="font-size:10px;font-weight:normal;">(In ETB)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label"></label>
							  ...
							  <input  type="hidden" name="p_return_policy" value="">
						</div>
						<div class="form-group">
