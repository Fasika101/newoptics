...
<section class="content-header">
	<div class="content-header-left">
		<h1>Payment Confirmed Orders</h1>
	</div>
</section>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_payment where cust_type='Individual' AND payment_method='Telebirr' AND payment_status='Completed' AND shipping_status='Pending'");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
