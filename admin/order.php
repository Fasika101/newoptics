        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php
            	$i=0;
            	$statement = $pdo->prepare("SELECT * FROM tbl_payment where cust_type='Individual'  AND payment_method='Bank Deposit'");
            	$statement->execute();
            	$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
            	foreach ($result as $row) {
            		$i++;
                    ...
                    <td ><?php echo $i; ?></td>
                     <td style="width:130px;">
                           ...
                           foreach ($result1 as $row1) {
                               ...
                               ?>
                               <a href="../assets/uploads/prescription_photos/<?php echo $imagelink; ?>" target="_blank"><?php echo $row1['photo']; ?></a>
                        ...
                        <td>
                           ...
                           foreach ($result1 as $row1) {
                                ...
                                echo '<br> <b>Total Price</b> Price:</b> '.$row1['unit_price'].'ETB)';
                                echo '<br><br>';
                           }
                           ?>
                        </td>
...
?>
                        ...
                        <td><?php echo $row['paid_amount'].' ETB'; ?></td>
                        <td>
