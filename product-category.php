...
<div class="page-banner" style="padding-top: 0px;  background-image: url(assets/uploads/<?php echo $banner_product_category; ?>)">
    <div class="inner">
        <h1 style="color: rgb(51, 51, 51); padding-top: 20px;"><?php echo LANG_VALUE_50; ?> <?php echo $title; ?></h1>
    </div>
</div>
                                    ...
                                    <div class="col-md-4 item item-product-cat">
                                        <div class="inner">
                                            ...
                                            <div class="text">
                                                ...
                                                <h4>
                                                    <?php echo '<span style="color:#228B22;">ETB </span>'; ?><?php echo $row['p_current_price']; ?> 
